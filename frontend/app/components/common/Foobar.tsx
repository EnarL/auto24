...
const Foobar: React.FC = () => {
    return (
        <footer className="text-white p-8 mx-auto flex flex-col mt-16 text-[16px] bg-green-600 w-full max-w-[1200px]">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8">
                <p className="text-lg font-bold">&copy; 2025 Car Sale Platform. All rights reserved.</p>
                <ul className="flex flex-col md:flex-row gap-6 mt-4 md:mt-0">
                    <li><Link href="/about" className="hover:underline hover:text-gray-200">About Us</Link></li>
                    <li><Link href="/contact" className="hover:underline hover:text-gray-200">Contact</Link></li>
                    <li><Link href="/privacy" className="hover:underline hover:text-gray-200">Privacy Policy</Link></li>
                    <li><Link href="/terms" className="hover:underline hover:text-gray-200">Terms of Service</Link></li>
                </ul>
            </div>

            <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
                <div className="flex gap-6">
                    <Link href="#" className="hover:scale-110 transition-transform duration-300" aria-label="Facebook">
                    ...
                    <Link href="#" className="hover:scale-110 transition-transform duration-300" aria-label="Twitter">
                        <svg className="w-6 h-6 text-gray-200 hover:text-white" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <Link href="#" className="hover:scale-110 transition-transform duration-300" aria-label="Instagram">
                        <svg className="w-6 h-6 text-gray-200 hover:text-white" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
