export const vehicleFields=[
    ...
    {name: "firstRegistrationDate", label: "Esmane reg. kuupäev", type: "text"},
    {name: "price", label: "Hind EUR", type: "text"},
    {name: "odometerReading", label: "Läbisõidumõõdiku näit km", type: "text"},
    ...
    {name: "fuelType", label: "Kütus", type: "text"},
